...
dunecore contains shared utility code, geometry, far detector channel maps, data products, framework interface and file i/o utitlies
for use in the DUNE offline software stack.
