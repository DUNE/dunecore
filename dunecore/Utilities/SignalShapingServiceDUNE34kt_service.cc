////////////////////////////////////////////////////////////////////////
/// \file   SignalShapingServiceDUNE34kt_service.cc
/// \author H. Greenlee 
////////////////////////////////////////////////////////////////////////

#include "dune/Utilities/SignalShapingServiceDUNE34kt.h"
...
util::SignalShapingServiceDUNE34kt::SignalShaping(unsigned int channel) const
{
  if(!fInit)
    init();
...
void util::SignalShapingServiceDUNE34kt::SetElectResponse(double shapingtime, double gain)
{
  ...
  LOG_DEBUG("SignalShapingDUNE34kt") << "Setting DUNE34kt electronics response function...";
  ...
  LOG_DEBUG("SignalShapingDUNE34kt") << " Done.";
...
namespace util {
  ...
  DEFINE_ART_SERVICE(SignalShapingServiceDUNE34kt)
