//
// Name:  SignalShapingDUNE10ktTest.h
//
// Purpose: SignalShapingDUNE10ktTest module.  Test convolution/deconvolution.
//
...
#include "dunecore/Utilities/SignalShapingServiceDUNE10kt.h"
...
namespace util
{
  class SignalShapingDUNE10ktTest : public art::EDAnalyzer
  {
  public:

    // Constructor, destructor.

    explicit SignalShapingDUNE10ktTest(fhicl::ParameterSet const& pset);
  ...
  DEFINE_ART_MODULE(SignalShapingDUNE10ktTest)

  SignalShapingDUNE10ktTest::SignalShapingDUNE10ktTest(const fhicl::ParameterSet& pset)
  : EDAnalyzer(pset)
  {}

  void SignalShapingDUNE10ktTest::beginJob()
  {
    // Get services.
  ...
  SignalShapingDUNE10ktTest::~SignalShapingDUNE10ktTest()
  {}

  void SignalShapingDUNE10ktTest::analyze(const art::Event& evt)
 {}
}
