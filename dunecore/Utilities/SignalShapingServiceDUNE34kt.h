...
//----------------------------------------------------------------------
// Do convolution.
template <class T> inline void util::SignalShapingServiceDUNE34kt::Convolute(unsigned int channel, std::vector<T>& func) const
{
...
//----------------------------------------------------------------------
// Do deconvolution.
template <class T> inline void util::SignalShapingServiceDUNE34kt::Deconvolute(unsigned int channel, std::vector<T>& func) const
{
