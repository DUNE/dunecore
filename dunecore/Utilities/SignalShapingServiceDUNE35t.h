///////////////////////////////////////////////////////////////////////
///
/// \file   SignalShapingServiceDUNE35t.h
///
...
#ifndef SIGNALSHAPINGSERVICEDUNE35T_H
#define SIGNALSHAPINGSERVICEDUNE35T_H
...
namespace util {
  ...
  public:
    ...
    SignalShapingServiceDUNE35t(const fhicl::ParameterSet& pset,
  ...
  private:
    ...
    void init() const{const_cast<SignalShapingServiceDUNE35t*>(this)->init();}
    void init();
...
DECLARE_ART_SERVICE(util::SignalShapingServiceDUNE35t, LEGACY)
#endif
