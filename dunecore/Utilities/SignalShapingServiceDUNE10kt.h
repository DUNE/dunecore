///////////////////////////////////////////////////////////////////////
///
/// \file   SignalShapingServiceDUNE10kt.h
///
...
#ifndef SIGNALSHAPINGSERVICEDUNE10KT_H
#define SIGNALSHAPINGSERVICEDUNE10KT_H
...
namespace util {
  ...
  public:
    ...
    SignalShapingServiceDUNE10kt(const fhicl::ParameterSet& pset,
  ...
  private:
    ...
    void init() const{const_cast<SignalShapingServiceDUNE10kt*>(this)->init();}
    void init();

    // Calculate response functions.
    // Copied from SimWireDUNE10kt.
...
//----------------------------------------------------------------------
// Do convolution.
template <class T> inline void util::SignalShapingServiceDUNE10kt::Convolute(unsigned int channel, std::vector<T>& func) const
{
...
//----------------------------------------------------------------------
// Do deconvolution.
template <class T> inline void util::SignalShapingServiceDUNE10kt::Deconvolute(unsigned int channel, std::vector<T>& func) const
{
...
DECLARE_ART_SERVICE(util::SignalShapingServiceDUNE10kt, LEGACY)
#endif
