...
////////////////////////////////////////////////////////////////////////
#ifndef GEO_WIREREADOUTCRMGEOM_H
#define GEO_WIREREADOUTCRMGEOM_H
...
namespace geo{
  ...
  class WireReadoutCRMGeom : public WireReadoutGeom{

  public:
    

    explicit WireReadoutCRMGeom(fhicl::ParameterSet const& p, GeometryCore const* geom);
...
#endif // GEO_WIREREADOUTCRMGEOM_H
