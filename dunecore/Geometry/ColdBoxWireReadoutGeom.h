...
#define DUNE_COLDBOXCHANNELMAPALG_H
...
class geo::ColdBoxWireReadoutGeom: public geo::WireReadoutGeom {
 ...
 public:
  ...
  explicit ColdBoxWireReadoutGeom(fhicl::ParameterSet const& p, GeometryCore const* geom);
  ...
  //
  std::string fLogCategory = "ColdBoxWireReadoutGeom";
  
}; // class geo::ColdBoxWireReadoutGeom
