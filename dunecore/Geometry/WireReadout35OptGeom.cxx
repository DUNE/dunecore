...
////////////////////////////////////////////////////////////////////////
///
/// This class is starting as a copy of WireReadout35Geom, plus one bug fix
...
namespace geo{
  ...
  //----------------------------------------------------------------------------
  WireReadout35OptGeom::WireReadout35OptGeom(fhicl::ParameterSet const& p,
                      ...
                      std::make_unique<WireReadoutSorter35>(p)}
  {
    ...
    mf::LogInfo("WireReadout35OptGeom") << "Initializing...";
    ...
    mf::LogVerbatim("WireReadout35OptGeom") << "fNchannels = " << fNchannels ;
    mf::LogVerbatim("WireReadout35OptGeom") << "U channels per APA = " << 2*nAnchoredWires[0][0][0] ;
    mf::LogVerbatim("WireReadout35OptGeom") << "V channels per APA = " << 2*nAnchoredWires[0][0][1] ;
    mf::LogVerbatim("WireReadout35OptGeom") << "Z channels per APA side = " << nAnchoredWires[0][0][2] ;
  ...
  //----------------------------------------------------------------------------
  std::vector<geo::WireID> WireReadout35OptGeom::ChannelToWire(raw::ChannelID_t channel)  const
  {
  ...
  //----------------------------------------------------------------------------
  unsigned int WireReadout35OptGeom::Nchannels() const
  {
    return fNchannels;
  }
  ...
  //----------------------------------------------------------------------------
  unsigned int WireReadout35OptGeom::Nchannels
    (readout::ROPID const& ropid) const
  {
    throw cet::exception("WireReadout35OptGeom") << __func__ << " not implemented!\n";
  } // WireReadout35OptGeom::Nchannels(ROPID)
  
  
  //----------------------------------------------------------------------------
  double WireReadout35OptGeom::WireCoordinate
...
//    const double rotate = (planeid.TPC % 2 == 1)? -1.: +1.;
  ...
  } // WireReadout35OptGeom::WireCoordinate()
  
  
  //----------------------------------------------------------------------------
  WireID WireReadout35OptGeom::NearestWireID
    (const geo::Point_t& xyz, geo::PlaneID const& planeid) const
  {
    ...
    /*
      ...
      throw InvalidWireIDError("Geometry", wireNumber, NearestWireNumber)
        << "WireReadout35OptGeom::NearestWireID(): can't Find Nearest Wire for position ("
        << xyz.X() << "," << xyz.Y() << "," << xyz.Z() << ")"
  ...
  } // WireReadout35OptGeom::NearestWireID()
  
  //----------------------------------------------------------------------------
  raw::ChannelID_t WireReadout35OptGeom::PlaneWireToChannel
  ...
  //----------------------------------------------------------------------------
  SigType_t WireReadout35OptGeom::SignalTypeForChannelImpl( raw::ChannelID_t const channel )  const
  {
  ...
  //----------------------------------------------------------------------------
  View_t WireReadout35OptGeom::View( raw::ChannelID_t const channel )  const
  {
    raw::ChannelID_t chan = channel % fChannelsPerAPA;
    View_t view = geo::kU;
  ...
  //----------------------------------------------------------------------------
  std::set<View_t> const& WireReadout35OptGeom::Views() const
  {
    return fViews;
  }

  //----------------------------------------------------------------------------
  std::set<PlaneID> const& WireReadout35OptGeom::PlaneIDs() const
  {
    return fPlaneIDs;
  }

  //----------------------------------------------------------------------------
  unsigned int WireReadout35OptGeom::NOpChannels(unsigned int NOpDets) const
  {
    return 12*NOpDets;
  }

  //----------------------------------------------------------------------------
  unsigned int WireReadout35OptGeom::NOpHardwareChannels(unsigned int opDet) const
  {
    // CSU 3-sipm design
  ...
  //----------------------------------------------------------------------------
  unsigned int WireReadout35OptGeom::OpChannel(unsigned int detNum, unsigned int channel) const
  {
  ...
  //----------------------------------------------------------------------------
  unsigned int WireReadout35OptGeom::OpDetFromOpChannel(unsigned int opChannel) const
  {
  ...
  //----------------------------------------------------------------------------
  unsigned int WireReadout35OptGeom::HardwareChannelFromOpChannel(unsigned int opChannel) const
  {
  ...
  //----------------------------------------------------------------------------
  unsigned int WireReadout35OptGeom::NTPCsets
    (readout::CryostatID const& cryoid) const
  {
    throw cet::exception("WireReadout35OptGeom") << __func__ << " not implemented!\n";
  } // WireReadout35OptGeom::NTPCsets()
  
  
  //----------------------------------------------------------------------------
  unsigned int WireReadout35OptGeom::MaxTPCsets() const
  {
    throw cet::exception("WireReadout35OptGeom") << __func__ << " not implemented!\n";
  } // WireReadout35OptGeom::MaxTPCsets()
  
  
  //----------------------------------------------------------------------------
  bool WireReadout35OptGeom::HasTPCset(readout::TPCsetID const& tpcsetid) const
  {
    return tpcsetid.TPCset < NTPCsets(tpcsetid);
  } // WireReadout35OptGeom::HasTPCset()
  
  
  //----------------------------------------------------------------------------
  readout::TPCsetID WireReadout35OptGeom::TPCtoTPCset
    (geo::TPCID const& tpcid) const
  {
    throw cet::exception("WireReadout35OptGeom") << __func__ << " not implemented!\n";
  } // WireReadout35OptGeom::TPCtoTPCset()
  
  
  //----------------------------------------------------------------------------
  std::vector<geo::TPCID> WireReadout35OptGeom::TPCsetToTPCs
    (readout::TPCsetID const& tpcsetid) const
  {
    throw cet::exception("WireReadout35OptGeom") << __func__ << " not implemented!\n";
  } // WireReadout35OptGeom::TPCsetToTPCs()
  
  
  //----------------------------------------------------------------------------
  geo::TPCID WireReadout35OptGeom::FirstTPCinTPCset
    (readout::TPCsetID const& tpcsetid) const
  {
    throw cet::exception("WireReadout35OptGeom") << __func__ << " not implemented!\n";
  } // WireReadout35OptGeom::FirstTPCinTPCset()
  
  
  //----------------------------------------------------------------------------
  unsigned int WireReadout35OptGeom::NROPs
      (readout::TPCsetID const& tpcsetid) const
  {
    throw cet::exception("WireReadout35OptGeom") << __func__ << " not implemented!\n";
  } // WireReadout35OptGeom::NROPs()
  
  
  //----------------------------------------------------------------------------
  unsigned int WireReadout35OptGeom::MaxROPs() const {
    throw cet::exception("WireReadout35OptGeom") << __func__ << " not implemented!\n";
  } // WireReadout35OptGeom::MaxROPs()
  
  
  //----------------------------------------------------------------------------
  bool WireReadout35OptGeom::HasROP(readout::ROPID const& ropid) const {
    return ropid.ROP < NROPs(ropid);
  } // WireReadout35OptGeom::HasROP()
  
  
  //----------------------------------------------------------------------------
  readout::ROPID WireReadout35OptGeom::WirePlaneToROP
    (geo::PlaneID const& planeid) const
  {
    throw cet::exception("WireReadout35OptGeom") << __func__ << " not implemented!\n";
  } // WireReadout35OptGeom::WirePlaneToROP()
  
  
  //----------------------------------------------------------------------------
  std::vector<geo::PlaneID> WireReadout35OptGeom::ROPtoWirePlanes
    (readout::ROPID const& ropid) const
  {
    throw cet::exception("WireReadout35OptGeom") << __func__ << " not implemented!\n";
  } // WireReadout35OptGeom::ROPtoWirePlanes()
  
  
  //----------------------------------------------------------------------------
  std::vector<geo::TPCID> WireReadout35OptGeom::ROPtoTPCs
    (readout::ROPID const& ropid) const
  {
    throw cet::exception("WireReadout35OptGeom") << __func__ << " not implemented!\n";
  } // WireReadout35OptGeom::ROPtoTPCs()
  
  
  //----------------------------------------------------------------------------
  readout::ROPID WireReadout35OptGeom::ChannelToROP
  ...
  //----------------------------------------------------------------------------
  raw::ChannelID_t WireReadout35OptGeom::FirstChannelInROP
    (readout::ROPID const& ropid) const
  {
    throw cet::exception("WireReadout35OptGeom") << __func__ << " not implemented!\n";
  } // WireReadout35OptGeom::FirstChannelInROP()
  
  
  //----------------------------------------------------------------------------
  geo::PlaneID WireReadout35OptGeom::FirstWirePlaneInROP
    (readout::ROPID const& ropid) const
  {
    throw cet::exception("WireReadout35OptGeom") << __func__ << " not implemented!\n";
  } // WireReadout35OptGeom::FirstWirePlaneInROP()
