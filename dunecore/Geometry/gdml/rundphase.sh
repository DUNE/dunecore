...
# with wires for larcore
perl generate_dunedphase10kt_v2_driftY.pl -w 1 -k 3 -o dphase_geo_driftY_workspace3x3.xml
...
# no wires for geant
perl generate_dunedphase10kt_v2_driftY.pl -w 0 -k 3 -o dphase_geo_driftY_workspace3x3_nowires.xml -w 0
