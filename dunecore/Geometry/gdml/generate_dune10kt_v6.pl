...
$BeamPlugRad      = 10.48;
$BeamPlugNiRad    = 9.72;
$BeamPlugLe       = (44.6)/cos($BeamTheta3); #with current geometry and 49.22 Dz the flange's front face just touches the active volume.
$BeamPlugNiLe     = $BeamPlugLe-0.59/cos($BeamTheta3);

$BeamPlugPosDZ    = $SteelPlate + $FoamPadding + $SteelThickness + $BeamPlugLe*cos($BeamTheta3)/2;
...
$BePlFlangePosDZ    = $SteelPlate + $FoamPadding + $SteelThickness + $BeamPlugLe*cos($BeamTheta3); #This is Dz to the end of the beam plug pipe needed for x,y position.
...
$posCRTModUS1_z = - ($Cryostat_z/2 + $SteelSupport_z + $FoamPadding) - 63.1;
$posCRTModUS2_z = - ($Cryostat_z/2 + $SteelSupport_z + $FoamPadding) - 88.1;
$posCRTModUS3_z = - ($Cryostat_z/2 + $SteelSupport_z + $FoamPadding) - 768.1;
$posCRTModUS4_z = - ($Cryostat_z/2 + $SteelSupport_z + $FoamPadding) - 793.1;
$posCRTModDS1_z =   ($Cryostat_z/2 + $SteelSupport_z + $FoamPadding) + 124.25;
$posCRTModDS2_z =   ($Cryostat_z/2 + $SteelSupport_z + $FoamPadding) + 124.25 + 25.0;
...
$posCRTDS_x[0] = $posCryoInDetEnc_x + 10./2 + (2.5 + $CRTModWidth)/2;
$posCRTDS_y[0] = $posCryoInDetEnc_y + 10./2 + 2.5/2 + $CRTModLength/2;
$posCRTDS_z[0] = $posCRTModDS1_z;
$posCRTDS_rot[0] = "rPlus90AboutX";

$posCRTDS_x[1] = $posCryoInDetEnc_x + 10./2 + 5. + 3*(2.5 + $CRTModWidth)/2;
$posCRTDS_y[1] = $posCryoInDetEnc_y + 10./2 + 2.5/2 + $CRTModLength/2;
$posCRTDS_z[1] = $posCRTModDS1_z;
$posCRTDS_rot[1] = "rPlus90AboutX";   

$posCRTDS_x[2] = $posCryoInDetEnc_x + 10./2 + 2.5/2 + $CRTModLength/2;
$posCRTDS_y[2] = $posCryoInDetEnc_y + 10./2 + (2.5 + $CRTModWidth)/2;
$posCRTDS_z[2] = $posCRTModDS2_z;
$posCRTDS_rot[2] = "rMinus90AboutYMinus90AboutX";

$posCRTDS_x[3] = $posCryoInDetEnc_x + 10./2 + 2.5/2 + $CRTModLength/2;
$posCRTDS_y[3] = $posCryoInDetEnc_y + 10./2 + 5. + 3*(2.5 + $CRTModWidth)/2;
$posCRTDS_z[3] = $posCRTModDS2_z;
$posCRTDS_rot[3] = "rMinus90AboutYMinus90AboutX";

$posCRTDS_x[4] = $posCryoInDetEnc_x + 10./2 + (2.5 + $CRTModWidth)/2;
$posCRTDS_y[4] = $posCryoInDetEnc_y - 10./2 - 2.5/2 - $CRTModLength/2;
$posCRTDS_z[4] = $posCRTModDS2_z;
$posCRTDS_rot[4] = "rPlus90AboutX";

$posCRTDS_x[5] = $posCryoInDetEnc_x + 10./2 + 5. + 3*(2.5 + $CRTModWidth)/2;
$posCRTDS_y[5] = $posCryoInDetEnc_y - 10./2 - 2.5/2 - $CRTModLength/2;
$posCRTDS_z[5] = $posCRTModDS2_z;
$posCRTDS_rot[5] = "rPlus90AboutX";

$posCRTDS_x[6] = $posCryoInDetEnc_x + 10./2 + 2.5/2 + $CRTModLength/2;
$posCRTDS_y[6] = $posCryoInDetEnc_y - 10./2 - (2.5 + $CRTModWidth)/2;
$posCRTDS_z[6] = $posCRTModDS1_z;
$posCRTDS_rot[6] = "rMinus90AboutYMinus90AboutX";

$posCRTDS_x[7] = $posCryoInDetEnc_x + 10./2 + 2.5/2 + $CRTModLength/2;
$posCRTDS_y[7] = $posCryoInDetEnc_y - 10./2 - 5. - 3*(2.5 + $CRTModWidth)/2;
$posCRTDS_z[7] = $posCRTModDS1_z;
$posCRTDS_rot[7] = "rMinus90AboutYMinus90AboutX";

$posCRTDS_x[8] = $posCryoInDetEnc_x - 10./2 - (2.5 + $CRTModWidth)/2;
$posCRTDS_y[8] = $posCryoInDetEnc_y + 10./2 + 2.5/2 + $CRTModLength/2;
$posCRTDS_z[8] = $posCRTModDS2_z;
$posCRTDS_rot[8] = "rPlus90AboutX";

$posCRTDS_x[9] = $posCryoInDetEnc_x - 10./2 - 5. - 3*(2.5 + $CRTModWidth)/2;
$posCRTDS_y[9] = $posCryoInDetEnc_y + 10./2 + 2.5/2 + $CRTModLength/2;
$posCRTDS_z[9] = $posCRTModDS2_z;
$posCRTDS_rot[9] = "rPlus90AboutX";

$posCRTDS_x[10] = $posCryoInDetEnc_x - 10./2 - 2.5/2 - $CRTModLength/2;
$posCRTDS_y[10] = $posCryoInDetEnc_y + 10./2 + (2.5 + $CRTModWidth)/2;
$posCRTDS_z[10] = $posCRTModDS1_z;
$posCRTDS_rot[10] = "rMinus90AboutYMinus90AboutX";

$posCRTDS_x[11] = $posCryoInDetEnc_x - 10./2 - 2.5/2 - $CRTModLength/2;
$posCRTDS_y[11] = $posCryoInDetEnc_y + 10./2 + 5. + 3*(2.5 + $CRTModWidth)/2;
$posCRTDS_z[11] = $posCRTModDS1_z;
$posCRTDS_rot[11] = "rMinus90AboutYMinus90AboutX";

$posCRTDS_x[12] = $posCryoInDetEnc_x - 10./2 - (2.5 + $CRTModWidth)/2;
$posCRTDS_y[12] = $posCryoInDetEnc_y - 10./2 - 2.5/2 - $CRTModLength/2;
$posCRTDS_z[12] = $posCRTModDS1_z;
$posCRTDS_rot[12] = "rPlus90AboutX";

$posCRTDS_x[13] = $posCryoInDetEnc_x - 10./2 - 5. - 3*(2.5 + $CRTModWidth)/2;
$posCRTDS_y[13] = $posCryoInDetEnc_y - 10./2 - 2.5/2 - $CRTModLength/2;
$posCRTDS_z[13] = $posCRTModDS1_z;
$posCRTDS_rot[13] = "rPlus90AboutX";

$posCRTDS_x[14] = $posCryoInDetEnc_x - 10./2 - 2.5/2 - $CRTModLength/2;
$posCRTDS_y[14] = $posCryoInDetEnc_y - 10./2 - (2.5 + $CRTModWidth)/2;
$posCRTDS_z[14] = $posCRTModDS2_z;
$posCRTDS_rot[14] = "rMinus90AboutYMinus90AboutX";

$posCRTDS_x[15] = $posCryoInDetEnc_x - 10./2 - 2.5/2 - $CRTModLength/2;
$posCRTDS_y[15] = $posCryoInDetEnc_y - 10./2 - 5. - 3*(2.5 + $CRTModWidth)/2;
$posCRTDS_z[15] = $posCRTModDS2_z;
...
$posCRTUS_x[0] = $posCryoInDetEnc_x + 10./2 + (2.5 + $CRTModWidth)/2 + $posCRTUSoff_x1;
$posCRTUS_y[0] = $posCryoInDetEnc_y + 10./2 + 2.5/2 + $CRTModLength/2;
$posCRTUS_z[0] = $posCRTModUS1_z;
$posCRTUS_rot[0] = "rPlus90AboutX";

$posCRTUS_x[1] = $posCryoInDetEnc_x + 10./2 + 5. + 3*(2.5 + $CRTModWidth)/2 + $posCRTUSoff_x1;
$posCRTUS_y[1] = $posCryoInDetEnc_y + 10./2 + 2.5/2 + $CRTModLength/2;
$posCRTUS_z[1] = $posCRTModUS1_z;
$posCRTUS_rot[1] = "rPlus90AboutX";

$posCRTUS_x[2] = $posCryoInDetEnc_x + 10./2 + 2.5/2 + $CRTModLength/2 + $posCRTUSoff_x1;
$posCRTUS_y[2] = $posCryoInDetEnc_y + 10./2 + (2.5 + $CRTModWidth)/2;
$posCRTUS_z[2] = $posCRTModUS2_z;
$posCRTUS_rot[2] = "rMinus90AboutYMinus90AboutX";

$posCRTUS_x[3] = $posCryoInDetEnc_x + 10./2 + 2.5/2 + $CRTModLength/2 + $posCRTUSoff_x1;
$posCRTUS_y[3] = $posCryoInDetEnc_y + 10./2 + 5. + 3*(2.5 + $CRTModWidth)/2;
$posCRTUS_z[3] = $posCRTModUS2_z;
$posCRTUS_rot[3] = "rMinus90AboutYMinus90AboutX";

$posCRTUS_x[4] = $posCryoInDetEnc_x + 10./2 + (2.5 + $CRTModWidth)/2 + $posCRTUSoff_x1;
$posCRTUS_y[4] = $posCryoInDetEnc_y - 10./2 - 2.5/2 - $CRTModLength/2;
$posCRTUS_z[4] = $posCRTModUS2_z;
$posCRTUS_rot[4] = "rPlus90AboutX";

$posCRTUS_x[5] = $posCryoInDetEnc_x + 10./2 + 5. + 3*(2.5 + $CRTModWidth)/2 + $posCRTUSoff_x1;
$posCRTUS_y[5] = $posCryoInDetEnc_y - 10./2 - 2.5/2 - $CRTModLength/2;
$posCRTUS_z[5] = $posCRTModUS2_z;
$posCRTUS_rot[5] = "rPlus90AboutX";

$posCRTUS_x[6] = $posCryoInDetEnc_x + 10./2 + 2.5/2 + $CRTModLength/2 + $posCRTUSoff_x1;
$posCRTUS_y[6] = $posCryoInDetEnc_y - 10./2 - (2.5 + $CRTModWidth)/2;
$posCRTUS_z[6] = $posCRTModUS1_z;
$posCRTUS_rot[6] = "rMinus90AboutYMinus90AboutX";

$posCRTUS_x[7] = $posCryoInDetEnc_x + 10./2 + 2.5/2 + $CRTModLength/2 + $posCRTUSoff_x1;
$posCRTUS_y[7] = $posCryoInDetEnc_y - 10./2 - 5. - 3*(2.5 + $CRTModWidth)/2;
$posCRTUS_z[7] = $posCRTModUS1_z;
$posCRTUS_rot[7] = "rMinus90AboutYMinus90AboutX";

$posCRTUS_x[8] = $posCryoInDetEnc_x - 10./2 - (2.5 + $CRTModWidth)/2 + $posCRTUSoff_x2;
$posCRTUS_y[8] = $posCryoInDetEnc_y + 10./2 + 2.5/2 + $CRTModLength/2;
$posCRTUS_z[8] = $posCRTModUS4_z;
$posCRTUS_rot[8] = "rPlus90AboutX";

$posCRTUS_x[9] = $posCryoInDetEnc_x - 10./2 - 5. - 3*(2.5 + $CRTModWidth)/2 + $posCRTUSoff_x2;
$posCRTUS_y[9] = $posCryoInDetEnc_y + 10./2 + 2.5/2 + $CRTModLength/2;
$posCRTUS_z[9] = $posCRTModUS4_z;
$posCRTUS_rot[9] = "rPlus90AboutX";

$posCRTUS_x[10] = $posCryoInDetEnc_x - 10./2 - 2.5/2 - $CRTModLength/2 + $posCRTUSoff_x2;
$posCRTUS_y[10] = $posCryoInDetEnc_y + 10./2 + (2.5 + $CRTModWidth)/2;
$posCRTUS_z[10] = $posCRTModUS3_z;
$posCRTUS_rot[10] = "rMinus90AboutYMinus90AboutX";

$posCRTUS_x[11] = $posCryoInDetEnc_x - 10./2 - 2.5/2 - $CRTModLength/2 + $posCRTUSoff_x2;
$posCRTUS_y[11] = $posCryoInDetEnc_y + 10./2 + 5. + 3*(2.5 + $CRTModWidth)/2;
$posCRTUS_z[11] = $posCRTModUS3_z;
$posCRTUS_rot[11] = "rMinus90AboutYMinus90AboutX";

$posCRTUS_x[12] = $posCryoInDetEnc_x - 10./2 - (2.5 + $CRTModWidth)/2 + $posCRTUSoff_x2;
$posCRTUS_y[12] = $posCryoInDetEnc_y - 10./2 - 2.5/2 - $CRTModLength/2;
$posCRTUS_z[12] = $posCRTModUS3_z;
$posCRTUS_rot[12] = "rPlus90AboutX";

$posCRTUS_x[13] = $posCryoInDetEnc_x - 10./2 - 5. - 3*(2.5 + $CRTModWidth)/2 + $posCRTUSoff_x2;
$posCRTUS_y[13] = $posCryoInDetEnc_y - 10./2 - 2.5/2 - $CRTModLength/2;
$posCRTUS_z[13] = $posCRTModUS3_z;
$posCRTUS_rot[13] = "rPlus90AboutX";

$posCRTUS_x[14] = $posCryoInDetEnc_x - 10./2 - 2.5/2 - $CRTModLength/2 + $posCRTUSoff_x2;
$posCRTUS_y[14] = $posCryoInDetEnc_y - 10./2 - (2.5 + $CRTModWidth)/2;
$posCRTUS_z[14] = $posCRTModUS4_z;
$posCRTUS_rot[14] = "rMinus90AboutYMinus90AboutX";

$posCRTUS_x[15] = $posCryoInDetEnc_x - 10./2 - 2.5/2 - $CRTModLength/2 + $posCRTUSoff_x2;
$posCRTUS_y[15] = $posCryoInDetEnc_y - 10./2 - 5. - 3*(2.5 + $CRTModWidth)/2;
$posCRTUS_z[15] = $posCRTModUS4_z;
...
#$gapCenterLeft_arapuca_z = 1.5875;
...
#nAraAPAi is the number of the APA that the ith arapuca bar goes into and nSlotArai, its slot in that APA. Numbers to be confirmed for ProtoDune. If you don't want arapucas, use this numbers out of the range (e.g. negative)
...
<solids>
    ...
    <cutTube name="BeamPlug_0" rmin="$BeamPlugNiRad" rmax="$BeamPlugRad" z="$BeamPlugLe" startphi="0" deltaphi="360" lowX="-0.278696241193" lowY="0" lowZ="-0.960379302747" highX="0.278696241193" highY="0" highZ="0.960379302747" aunit="deg" lunit="cm"/>
...
print CRYO <<EOF;
    ...
    <subtraction name="boxFCEW-BP-mod">
      ...
      <position name="posboxFCEW-BP-mod" x="150.75" y="40" z="0" unit="cm"/>
    </subtraction>
    <subtraction name="FCEW-BP-FieldShaping">
      <first ref="boxFCEWFieldShaping"/>
      <second ref="boxBePlHoleFiSh"/>
      <position name="posFCEW-BP-FieldShapingSol" x="150.75" y="40" z="0" unit="cm"/>
    </subtraction>
    ...
    <box name="boxFCXBarRem" x="352.001" y="13.9" z="3.5" lunit="cm"/>
    ...
    <subtraction name="FCXBarOut-1">
      ...
      <position name="posFCXBarOutSol-1" x="0" y="0" z="2.051" unit="cm"/>
    </subtraction>
    <subtraction name="FCXBarOut-2">
      <first ref="FCXBarOut-1"/>
      <second ref="boxFCXBarRem"/>
      <position name="posFCXBarOutSol-2" x="0" y="0" z="-2.051" unit="cm"/>
    </subtraction>
...
$posPitInConcrete_y =   $dimEnclConcrete_y/2 - $dimPitDepth/2 + 0.1;
$posPitInConcrete_z = - $DetEncLength/2 + $dimPitLength/2 - 0.1;
