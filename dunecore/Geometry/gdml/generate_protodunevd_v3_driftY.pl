...
#           -Since we are in driftY configuration x and y of the SteelSupport structure does not have to be flipped. overlap does not exist anymore and
#            volSteelSuport_LS/RS/Bottom/Top have been moved back to their nominal position
##################################################################################
...
$Argon_x = 854.8; #flag swapped y and x dimensions
$Argon_y = 790.0; #flag
$Argon_z = 854.8;
...
$xLArBuffer = 0.5 * ($Argon_x - $widthTPCActive);  #flag swapped x and y roles
...
$posTopSteelStruct = $Argon_y/2+$FoamPadding+ 2*$SteelSupport_y + 61.8/2; ## JS Real, add boxCryoTop dz/2.
$posBotSteelStruct = -$Argon_y/2-$FoamPadding- 2*$SteelSupport_y - 61.8/2;
$posZBackSteelStruct = $Argon_z/2+$FoamPadding+ 2*$SteelSupport_z + 61.8/2;  ## JS Real, add boxCryoWallSm dz/2.
$posZFrontSteelStruct = -$Argon_z/2-$FoamPadding- 2*$SteelSupport_z - 61.8/2;
$posLeftSteelStruct = $Argon_x/2+$FoamPadding+ 2*$SteelSupport_x + 61.8/2;  ## JS Real, add boxCryoWallLg dz/2.
$posRightSteelStruct = -$Argon_x/2-$FoamPadding- 2*$SteelSupport_x - 61.8/2;
...
#flag : X and Y positions modified as follow

# in v3 driftX perl script : 
...
$thetaYZ  = 45.0; #flagtemp change theta3_xz --> theta3_yz & theta_yz --> - theta_xz
$theta3XZ = 7.7;
#$theta3YZ  = -45.0;
#$thetaXZ = 7.7;
...
$BeamTheta3 = atan (sqrt(tan(deg2rad($theta3XZ))**2 +tan(deg2rad($thetaYZ))**2)); #flagtemp
$BeamPhi3   = atan (tan(deg2rad($thetaYZ))/tan(deg2rad($theta3XZ)));
#$BeamTheta3 = atan (sqrt(tan(deg2rad($theta3YZ))**2 +tan(deg2rad($thetaXZ))**2));
#$BeamPhi3   = atan (tan(deg2rad($thetaXZ))/tan(deg2rad($theta3YZ)));
...
$BeamWStPlateFF_x =   634.2 - $Cryostat_y / 2.0; #flagtemp : Cryostat_y and cryostat_x have been swapped, unswap them to keep calculation consistency
$BeamWStPlateFF_y =   $Cryostat_x / 2.0 + $SteelSupport_x + $FoamPadding;
$BeamWStPlateFF_z =   - ($Cryostat_z/2 + $FoamPadding + $SteelPlate);

$BeamWStPlateLe   = $SteelPlate/cos($BeamTheta3)+0.001;
$BeamWStPlate_x   = $BeamWStPlateFF_x - ($SteelPlate/2.0)*$DeltaXZ3; #flagtemp x <--> y
$BeamWStPlate_y   = $BeamWStPlateFF_y - ($SteelPlate/2.0)*$DeltaYZ3;
#$BeamWStPlate_y   = $BeamWStPlateFF_y - ($SteelPlate/2.0)*$DeltaYZ3; #flagtemp x <--> y
...
$BeamWFoRem_x     = $BeamWStPlateFF_x - $BeamWFoRemPosDZ*$DeltaXZ3; #flagtemp x <--> y
...
$BeamWStSu_x      = $BeamWStPlateFF_x - $BeamWStSuPosDZ*$DeltaXZ3; #flagtemp x <--> y
...
$BeamWFo_x        = $BeamWStPlateFF_x - $BeamWFoPosDZ*$DeltaXZ3; #flagtemp x <--> y
$BeamWFo_y        = $BeamWStPlateFF_y - $BeamWFoPosDZ*$DeltaYZ3 + $posCryoInDetEnc_y;
#$BeamWFo_y        = $BeamWStPlateFF_y - $BeamWFoPosDZ*$DeltaYZ3;
#$BeamWFo_x        = $BeamWStPlateFF_x - $BeamWFoPosDZ*$DeltaXZ3 + $posCryoInDetEnc_x;
...
$BeamWGl_x        = $BeamWStPlateFF_x - $BeamWGlPosDZ*$DeltaXZ3; #flagtemp x <--> y
$BeamWGl_y        = $BeamWStPlateFF_y - $BeamWGlPosDZ*$DeltaYZ3 + $posCryoInDetEnc_y;
#$BeamWGl_y        = $BeamWStPlateFF_y - $BeamWGlPosDZ*$DeltaYZ3; #flagtemp x <--> y
#$BeamWGl_x        = $BeamWStPlateFF_x - $BeamWGlPosDZ*$DeltaXZ3 + $posCryoInDetEnc_x; 
...
$BeamWVa_x        = $BeamWStPlateFF_x - $BeamWVaPosDZ*$DeltaXZ3; #flagtemp swap x and y
$BeamWVa_y        = $BeamWStPlateFF_y - $BeamWVaPosDZ*$DeltaYZ3 + $posCryoInDetEnc_y;
#$BeamWVa_y        = $BeamWStPlateFF_y - $BeamWVaPosDZ*$DeltaYZ3;
#$BeamWVa_x        = -($BeamWStPlateFF_x - $BeamWVaPosDZ*$DeltaXZ3 + $posCryoInDetEnc_x)-1000.;
...
$BeamPlug_x       = $BeamWStPlateFF_x - $BeamPlugPosDZ*$DeltaXZ3; #flagtemp x <--> y
$BeamPlug_y       = $BeamWStPlateFF_y - $BeamPlugPosDZ*$DeltaYZ3;
#$BeamPlug_y       = $BeamWStPlateFF_y - $BeamPlugPosDZ*$DeltaYZ3; #flagtemp x <--> y
...
$BePlFlange_x       = $BeamWStPlateFF_x - $BePlFlangePosDZ*$DeltaXZ3; #flagtemp x <--> y
...
#$BeamPlugMemb_y = $BeamWStPlateFF_y - $BeamPlugMembPosDZ*$DeltaYZ3; #flagtemp x <--> y
#$BeamPlugMemb_x = $BeamWStPlateFF_x - $BeamPlugMembPosDZ*$DeltaXZ3; 
...
$BWFFCoord3X   =       $BeamWStPlateFF_x - $BeamWStSuPosDZ*$DeltaXZ3*2 #flagtemp : swap OriginXSet and OriginYSet to be consistent with calculations in driftX geometry
                    +  $OriginYSet;
$BWFFCoord3Y   =       $BeamWStPlateFF_y - $BeamWStSuPosDZ*$DeltaYZ3*2
                    +  $OriginXSet + $posCryoInDetEnc_x;   
...
#$BW3StPlCoordX =  $BeamWStPlateFF_x + $OriginXSet; #flagtemp : swap OriginXSet and OriginYSet to be consistent with calculations in driftX geometry
#$BW3StPlCoordY =  $BeamWStPlateFF_y + $OriginYSet + $posCryoInDetEnc_y;
$BW3StPlCoordX =  $BeamWStPlateFF_x + $OriginYSet;
$BW3StPlCoordY =  $BeamWStPlateFF_y + $OriginXSet + $posCryoInDetEnc_x;
...
$FieldCageSizeX = $FieldShaperWidth+2; #flag swapped x and y dimensions
$FieldCageSizeY = $FieldShaperSeparation*$NFieldShapers+2; #flag swapped x and y dimensions
...
$BeamSpot_x = $posCryoInDetEnc_x + $CRTSurveyOrigin_x + $BeamSpotDSS_x +  $OriginYSet; #flagtemp swap originX and originY to keep calculation consitent in driftX geometry
$BeamSpot_y = $posCryoInDetEnc_y + $CRTSurveyOrigin_y + $BeamSpotDSS_y +  $OriginXSet; #WARNING : CRTSurveyOrigin_y and CRTSurveyOrigin_x should be changed with CRTs
...
$ArapucaOut_y = 65.0;  #flag x <--> y
$ArapucaOut_x = 2.5;
$ArapucaOut_z = 65.0; 
$ArapucaIn_y = 60.0; #flag x <--> y
$ArapucaIn_x = 2.0;
$ArapucaIn_z = 60.0;
$ArapucaAcceptanceWindow_y = 60.0; #flag x <--> y
...
$list_posy_bot[0]=-2*$widthCathodeVoid - 2.0*$CathodeBorder + $GapPD + 0.5*$ArapucaOut_y;
$list_posz_bot[0]= 0.5*$lengthCathodeVoid + $CathodeBorder;
#$list_posx_bot[1]= - $CathodeBorder - $GapPD - 0.5*$ArapucaOut_x;
$list_posy_bot[1]= - $CathodeBorder - $GapPD - 0.5*$ArapucaOut_y;
...
<define>
   ...
   <rotation name="rBeamWRev3DriftY"    unit="deg" x="-5.4611410351968113" y="-45" z="-84.563498378865177"/>
   <rotation name="rBeamPlII3"          unit="deg" x="-45" y="5.4611410351968113" z="-84.563498378865177"/>
   <rotation name="rBeamPlII3DriftY"    unit="deg" x="-5.4611410351968113" y="-45" z="-84.563498378865177"/>
</define>
</gdml>
EOF
    close (DEF);
...
# obsolete, relevant only for dual-phase geometry.
...
sub gen_Wires
{
	...
	#flag : modification to account for driftX-->driftY rotation
	$endpts[1]*=-1;
	$endpts[3]*=-1;
...
sub split_wires
{
	...
	#if( $y2 < $yref )
	if( $y1 > $yref ) #flag : swapped role of 1 and 2 (below) in logic conditions
	{
	...
	#elsif( $y1 > $yref )
	elsif( $y2 < $yref ) #flag : swapped role of 1 and 2 (above) in logic conditions
	{
...
sub gen_crm
{
    ...
    # CRM active volume
    my $TPCActive_y = $driftTPCActive; #flag swapped roles of x and y
    my $TPCActive_x = $widthCRP / 2; #flag
    my $TPCActive_z = $lengthCRP / 2;

    # CRM total volume
    my $TPC_y = $TPCActive_y + $ReadoutPlane; #flag : swapped roles of x and y
...
if ($wires_on==1) # add wires to U plane 
{
    ...
    my $offsetZ = 0; 
    #my $offsetY = 0; #flag : swap roles of Y to X
    my $offsetX = 0; 
    #
    foreach my $wire (@$winfoU) {
	my $wid  = $wire->[0];
	my $zpos = $wire->[1] + $offsetZ;
	#my $ypos = $wire->[2] + $offsetY; #flag
...
EOF
    ...
    #<position name="posWireU$wid" unit="cm" x="0" y="$ypos" z="$zpos"/>     ------->      <position name="posWireU$wid" unit="cm" x="$xpos" y="0" z="$zpos"/>
    #   <rotationref ref="rUWireAboutX"/>                                                               <rotationref ref="rUWireAboutY"/> 
...
if ($wires_on==1) # add wires to V plane 
  {
    ...
    # we need to move to plane coordinates
    my $offsetZ = 0; 
    #my $offsetY = 0; #flag : swap roles of x and y
    my $offsetX = 0; 
    
    foreach my $wire (@$winfoV) {
	my $wid  = $wire->[0];
	my $zpos = $wire->[1] + $offsetZ;
	#my $ypos = $wire->[2] + $offsetY; #flag swap roles of y-->x
	my $xpos = $wire->[2] + $offsetX;
print TPC <<EOF;
     <physvol>
...
EOF
    ...
    #flag : changes in the block are :
    # <position name="posWireV$wid" unit="cm" x="0" y="$ypos" z="$zpos"/> -->  <position name="posWireV$wid" unit="cm" x="$xpos" y="0" z="$zpos"/>
    # <rotationref ref="rVWireAboutX"/>  --> <rotationref ref="rVWireAboutY"/> 
}
print TPC <<EOF;
  </volume>
EOF
...
EOF
       } #flag : swapped rotation above from rPlus90AboutX to rPlus90AboutY
}
print TPC <<EOF;
  </volume>
EOF
...
my @posUplane = (0, 0, 0);
$posUplane[1] = 0.5*$TPC_y - 2.5*$padWidth; #flag swapped roles of x and y
$posUplane[0] = $pcbOffsetX; #flag
$posUplane[2] = $pcbOffsetZ;

my @posVplane = (0, 0, 0);
$posVplane[1] = 0.5*$TPC_y - 1.5*$padWidth; #flag swapped roles of x and y
$posVplane[0] = $pcbOffsetX; #flag 
$posVplane[2] = $pcbOffsetZ;

my @posZplane = (0, 0, 0);
$posZplane[1] = 0.5*$TPC_y - 0.5*$padWidth; #flag swapped roles of x and y
$posZplane[0] = $pcbOffsetX; #flag 
$posZplane[2] = $pcbOffsetZ;

my @posTPCActive = (0, 0, 0);
$posTPCActive[0] = 0; #flag swapped roles of x and y
$posTPCActive[1] = -$ReadoutPlane/2; #flag 
$posTPCActive[2] = 0;
...
sub gen_TopCRP
{
    ...
    my $CRP_y = $driftTPCActive + $ReadoutPlane; #flag swapped roles of x and y
    my $CRP_x = $widthCRP; #flag
    my $CRP_z = $lengthCRP;
...
#flag :
# driftX --> driftY comments : the field cage modifications are too numerous, but in the nutshell the basics elements are left unchanged, only the union of them is modified following 90° rotation around z.
# I mute the driftX block and copy the driftY block
...
#flag :
# driftX block is mute and is replaced by driftY block
...
# obsolete, was relevant for dual phase geometry, not vertical drift
sub gen_GroundGrid {
...
# --> <cutTube name="BeamPlIIIn" rmin="0" rmax="$BeamPlIINiRad" z="$BeamPlIILe" startphi="0" deltaphi="360" lowX="0" lowY="-0.71030185483404029" lowZ="-0.70389720486682006" highX="0" highY="0.71030185483404018" highZ="0.70389720486682017" aunit="deg" lunit="cm"/>
...
# --> <cutTube name="BeamPlIIOut" rmin="0" rmax="$BeamPlIIRad" z="$BeamPlIILe" startphi="0" deltaphi="360" lowX="0" lowY="-0.71030185483404029" lowZ="-0.70389720486682006" highX="0" highY="0.71030185483404018" highZ="0.70389720486682017" aunit="deg" lunit="cm"/>
...
# --> <cutTube name="BeamPlIICap" rmin="0" rmax="$BeamPlIIRad" z="0.5" startphi="0" deltaphi="360" lowX="0" lowY="-0.71030185483404029" lowZ="-0.70389720486682006" highX="0" highY="0.71030185483404018" highZ="0.70389720486682017" aunit="deg" lunit="cm"/>
...
print CRYO <<EOF;
    ...
    <subtraction name="GaseousArgonSub1">
      ...
      <position name="posGasArSub1" x="@{[+$widthCathode + $FCToArapucaSpaceLat]}" y="@{[-0.5*$HeightGaseousAr  - $FirstFrameVertDist - $ReadoutPlane]}" z="@{[-0.5*$Argon_z + $zLArBuffer + 0.5*$lengthCathode]}" unit="cm"/>
    </subtraction>
...
#flag : above swapped
##<box name="GaseousArgonFull" lunit="cm"   ---------> <box name="GaseousArgonFull" lunit="cm"
##      x="$HeightGaseousAr"                         x="$Argon_x"
##      y="$Argon_y"                                 y="$HeightGaseousAr"
##      z="$Argon_z"/>                               z="$Argon_z"/> 

#flag : probably stuff to work out regarding those arapuca gaseous stuff that were not in v1
...
#flag, above made the changes :
# ** <box name="ArapucaIn" lunit="cm"           ----------->           <box name="ArapucaIn" lunit="cm"
#      x="@{[$ArapucaOut_x]}"                                           x="@{[$ArapucaIn_x]}"
#      y="@{[$ArapucaIn_y]}"                                            y="@{[$ArapucaOut_y]}"
#      z="@{[$ArapucaIn_z]}"/>                                          z="@{[$ArapucaIn_z]}"/> 

# ** <subtraction name="ArapucaWalls">                                                        ---------> <subtraction name="ArapucaWalls"> 
#      <first  ref="ArapucaOut"/>                                                                                     <first  ref="ArapucaOut"/>
#      <second ref="ArapucaIn"/>                                                                                      <second ref="ArapucaIn"/>
#      <position name="posArapucaSub" x="0" y="@{[$ArapucaOut_y/2.0]}" z="0." unit="cm"/>                             <position name="posArapucaSub" x="-@{[$ArapucaOut_x/2.0]}" y="0." z="0." unit="cm"/>
#      </subtraction>                                                                                                  </subtraction>  

# **  <box name="ArapucaDoubleIn" lunit="cm"     -----------−−>            <box name="ArapucaDoubleIn" lunit="cm" 
#      x="@{[$ArapucaIn_x]}"                                                          x="@{[$ArapucaOut_x+1.0]}"
#      y="@{[$ArapucaOut_y+1.0]}"                                                     y="@{[$ArapucaIn_y]}"
#      z="@{[$ArapucaIn_z]}"/>                                                        z="@{[$ArapucaIn_z]}"/>                

# ** <box name="ArapucaDoubleAcceptanceWindow" lunit="cm"             ---------------->         <box name="ArapucaDoubleAcceptanceWindow" lunit="cm"
#      x="@{[$ArapucaOut_y-0.02]}"                                                                          x="@{[$ArapucaAcceptanceWindow_x]}"
#      y="@{[$ArapucaAcceptanceWindow_x]}"                                                                  y="@{[$ArapucaOut_y-0.02]}"
#      z="@{[$ArapucaAcceptanceWindow_z]}"/>                                                                z="@{[$ArapucaAcceptanceWindow_z]}"/>
...
#flagtemp
# added <rotation name="rPlus90AboutZ" unit="deg" x="0" y="0" z="90"/> into volume : volumeref ref="volBeamPlIINi"/>
...
#flag : changed posGaseousArgon, where x --> y
...
print CRYO <<EOF;
      <physvol>
        ...
        <position name="posBeamPlII3" unit="cm" x="-$BeamPlII_y" y="$BeamPlII_x" z="$BeamPlII_z"/>
        <rotationref ref="rBeamPlII3DriftY"/>
      </physvol>

      <physvol>
        <volumeref ref="volBeamPlIIUSCap"/>
        <position name="posBeamPlUSII3" unit="cm" x="-$BeamPlIIUSCap_y" y="$BeamPlIIUSCap_x" z="$BeamPlIIUSCap_z"/>
        <rotationref ref="rBeamPlII3"/>
      </physvol>

      <physvol>
        <volumeref ref="volBeamPlIIDSCap"/>
        <position name="posBeamPlDSII3" unit="cm" x="-$BeamPlIIDSCap_y" y="$BeamPlIIDSCap_x" z="$BeamPlIIDSCap_z"/>
        <rotationref ref="rBeamPlII3"/>
      </physvol>
EOF
...
#flagtemp : 
# <position name="posBeamPlII3" unit="cm" x="$BeamPlII_x" y="$BeamPlII_y" z="$BeamPlII_z"/> --> <position name="posBeamPlII3" unit="cm" x="-$BeamPlII_y" y="$BeamPlII_x" z="$BeamPlII_z"/>
# <position name="posBeamPlUSII3" unit="cm" x="$BeamPlIIUSCap_x" y="$BeamPlIIUSCap_y" z="$BeamPlIIUSCap_z"/> --> <position name="posBeamPlUSII3" unit="cm" x="-$BeamPlIIUSCap_y" y="$BeamPlIIUSCap_x" z="$BeamPlIIUSCap_z"/>
# <position name="posBeamPlDSII3" unit="cm" x="$BeamPlIIDSCap_x" y="$BeamPlIIDSCap_y" z="$BeamPlIIDSCap_z"/> --> <position name="posBeamPlDSII3" unit="cm" x="-$BeamPlIIDSCap_y" y="$BeamPlIIDSCap_x" z="$BeamPlIIDSCap_z"/>
...
{
  #$posX =  $Argon_x/2 - $HeightGaseousAr - 0.5*($driftTPCActive + $ReadoutPlane); #flag swap x --> y
  ...
  #my $CRP_y = $widthCRP; #flag : swap y --> x
  my $CRP_x = $widthCRP;
  my $CRP_z = $lengthCRP;
  #my $myposTCPY = 0;
  my $myposTCPX = 0;
  ...
  for(my $ii=0;$ii<$nCRM_z;$ii++)
  {
    ...
    #my $posY = -0.5*$Argon_y + $yLArBuffer + 0.5*$CRP_y; flag x --> y
    my $posX =-( -0.5*$Argon_x + $xLArBuffer + 0.5*$CRP_x );

    for(my $jj=0;$jj<$nCRM_x;$jj++)
    {
	#if( $jj % 2 == 0 && $jj>0){$posY += $CRP_y;} flag y --> -x
	if( $jj % 2 == 0 && $jj>0){$posX += -$CRP_x;}
    
	if($ii%2==0){
	  if($jj%2==0){
	    $quad=0;
	    #$myposTPCY = $posY-$CRP_y/4; #flag y --> -x
...
# in previous block, changed : 
# x="$posX" y="$myposTPCY" z="$myposTPCZ"/> -->  x="$myposTPCX" y="$posY" z="$myposTPCZ"/>
# x="$posXBot" y="$myposTPCY" z="$myposTPCZ"/> -->  x="$myposTPCX" y="$posYBot" z="$myposTPCZ"/>
# <rotationref ref="rPlus180AboutY"/> --> <rotationref ref="rPlus180AboutX"/> 
...
#$posX =  $Argon_x/2 - $HeightGaseousAr - 2*($driftTPCActive + $ReadoutPlane) - $heightCathode + $dist; #flag : x --> y
$posY =  $Argon_y/2 - $HeightGaseousAr - 2*($driftTPCActive + $ReadoutPlane) - $heightCathode + $dist; 
...
#$CathodePosX = $Argon_x/2 - $HeightGaseousAr - ($driftTPCActive + $ReadoutPlane) - 0.5*$heightCathode; #flag swapped x --> y
$CathodePosY = $Argon_y/2 - $HeightGaseousAr - ($driftTPCActive + $ReadoutPlane) - 0.5*$heightCathode;
#$CathodePosY = -0.5*$Argon_y + $yLArBuffer + 0.5*$widthCathode; #flag y --> -x
$CathodePosX = -( -0.5*$Argon_x + $xLArBuffer + 0.5*$widthCathode); 
...
EOF
       $idx++;
       #$CathodePosY += $widthCathode; #flag y --> -x
       $CathodePosX += -$widthCathode;
    }
       $CathodePosZ += $lengthCathode;
       #$CathodePosY = -0.5*$Argon_y + $yLArBuffer + 0.5*$widthCathode; #flag y --> x
       $CathodePosX = -0.5*$Argon_x + $yLArBuffer + 0.5*$widthCathode; 
  }
  }

#for placing the Arapucas over the cathode
  #$FrameCenter_y=-0.5*$Argon_y + $yLArBuffer + 0.5*$widthCathode; #flag  y --> x
  $FrameCenter_x=-0.5*$Argon_x + $xLArBuffer + 0.5*$widthCathode;
  #$FrameCenter_x=$CathodePosX; #flag x --> y
...
for($j=0;$j<$nCRM_z/2;$j++){
  ...
  #$FrameCenter_y+=$widthCathode; #flag y --> x
  $FrameCenter_x+=$widthCathode;
  $FrameCenter_z=-0.5*$Argon_z + $zLArBuffer + 0.5*$lengthCathode;
}

#for placing the Arapucas on laterals
  #$FrameCenter_x=$CathodePosX +$driftTPCActive +$heightCathode/2; #flag x --> y
  $FrameCenter_y = $CathodePosY +$driftTPCActive +$heightCathode/2;
  #$FrameCenter_y= -$widthCathode - $FCToArapucaSpaceLat; flag y --> x
  $FrameCenter_x = -$widthCathode - $FCToArapucaSpaceLat;
  $FrameCenter_z=-0.5*$Argon_z + $zLArBuffer + 0.5*$lengthCathode;
...
for ($ara = 0; $ara<4; $ara++)
{
 	     ...
 	     $Ara_Z = $FrameCenter_z+$list_posz_bot[$ara];
             ...
             #$Ara_X = $FrameCenter_x; #flag x --> y
             $Ara_Y = $FrameCenter_y;
             
             #if($Frame_x==1&&$ara==3){$Ara_Y = $FrameCenter_y+$list_posx_bot[2];
             #}else{$Ara_Y = $FrameCenter_y+$list_posx_bot[$ara];} 
             if($Frame_y==1&&$ara==3){$Ara_X = -($FrameCenter_x+$list_posy_bot[2]); #flag y <--> -x
             }else{$Ara_X = -($FrameCenter_x+$list_posy_bot[$ara]);} 
...
#flag <rotation name="rPlus90AboutXPlus90AboutZ" unit="deg" x="90" y="0" z="90"/> --> <rotation name="rPlus90AboutZ" unit="deg" x="0" y="0" z="90"/>
#flag added line for volOpDetSensitive_ArapucaDouble_$Frame_x\-$Frame_z\-$ara <rotation name="rPlus90AboutZ" unit="deg" x="0" y="0" z="90"/> 
...
$Ara_X = -$FrameCenter_x; #flag y --> -x
#$Ara_Y = $FrameCenter_y;
$Ara_Z = $FrameCenter_z;
             #if ($ara<4) {$Ara_YSens = ($Ara_Y+0.5*$ArapucaOut_y-0.5*$ArapucaAcceptanceWindow_y-0.01); #flag y --> -x
             #            $rot= "rIdentity"; }
             ...
             if ($ara<4) {$Ara_XSens = $Ara_X -( +0.5*$ArapucaOut_x-0.5*$ArapucaAcceptanceWindow_x-0.01);
                         $rot= "rIdentity"; }
             else {      $Ara_X = $Ara_X -(2*$widthCathode + 2*$FCToArapucaSpaceLat);
             ...
             if ($ara==0||$ara==4) {$Ara_Y = $FrameCenter_y-$FirstFrameVertDist;} #flag x --> y
             if ($ara==1||$ara==5) {$Ara_Y-=$VerticalPDdist;} #other tiles separated by VerticalPDdist
             if ($ara==2||$ara==6) {$Ara_Y = $FrameCenter_y - $heightCathode -2*$driftTPCActive+$FirstFrameVertDist;} #first tile's center distance from bottom anode
...
#flag swap x and y in block below
...
EOF
    ...
    #flag swap x and y values below
    if($DP_CRT_switch eq "on"){
        print ENCL <<EOF;
        <box name="scintBox_Top" lunit="mm" x="$TopCRTDPPaddleLength" y="$TopCRTDPPaddleHeight" z="$TopCRTDPPaddleWidth"/>
        <box name="scintBox_Bottom" lunit="mm"  x="$BottomCRTDPPaddleLength" y="$BottomCRTDPPaddleHeight" z="$BottomCRTDPPaddleWidth"/>
        <box name="ModulescintBox_Top" lunit="mm" x="$TopCRTDPModWidth" y="$TopCRTDPModHeight" z="$TopCRTDPModLength"/>
        <box name="ModulescintBox_Bottom" lunit="mm" x="$BottomCRTDPModWidth" y="$BottomCRTDPModHeight" z="$BottomCRTDPModLength"/>
EOF
    }
#flag below, change x and y dimensions for cathode blocks
# for positions, use y --> -x and x --> y for cathode

#for beam, trying this : 
...
# --> <cutTube name="BeamPipe" rmin="0" rmax="$BeamPipeRad" z="$BeamPipeLe" startphi="0" deltaphi="360" lowX="0" lowY="-0.71030185483404029" lowZ="-0.70389720486682006" highX="0." highY="0.71030185483404018" highZ="0.70389720486682017"  aunit="deg" lunit="cm"/>
...
# --> <cutTube name="BeamPipeVacuum" rmin="0" rmax="$BeamVaPipeRad" z="$BeamVaPipeLe" startphi="0" deltaphi="360" lowX="0." lowY="-0.71030185483404029" lowZ="-0.70389720486682006" highX="0" highY="0.71030185483404018" highZ="0.70389720486682017" aunit="deg" lunit="cm"/>
...
# --> <cutTube name="BeamWindowGlassWool" rmin="0" rmax="$BeamPipeRad" z="$BeamWGlLe" startphi="0" deltaphi="360" lowX="0." lowY="-0.71030185483404029" lowZ="-0.70389720486682006" highX="0." highY="0.71030185483404018" highZ="0.70389720486682017"  aunit="deg" lunit="cm"/>
...
# --> <cutTube name="BeamWindowFoam" rmin="0" rmax="$BeamPipeRad" z="$BeamWFoLe" startphi="0" deltaphi="360" lowX="0" lowY="-0.71030185483404029" lowZ="-0.70389720486682006" highX="0" highY="0.71030185483404018" highZ="0.70389720486682017"  aunit="deg" lunit="cm"/>
...
#flag : HD CRTs are still written for driftX geometry
...
# top CRT-DP module
#my $widthPalette=132+10; # spacing between paddle (mm)
print ENCL <<EOF;
<volume name="volAuxDetCRTDPModuleTop">
      <materialref ref="Air"/>
      <solidref ref="ModulescintBox_Top"/>
EOF
        my @poscrttop = (0., $TopCRTDPModHeight/2. - $TopCRTDPPaddleHeight/2., 0.);
        for($i=0 ; $i<8 ; $i++){
            $padnum = $i;
            $paddleindex = $padnum;
            print ENCL <<EOF;
    <physvol name="CRTDPTOP$padnum" copynumber="$paddleindex">
        ...
        <position name="posCRTPaddleSensitiveTop$padnum" unit="mm" x="0" y="$poscrttop[1]" z="0"/> 
        <rotationref ref="rMinus90AboutY"/>
    </physvol>
EOF
        $poscrttop[1] -= $CRTDPPaddleSpacing;
        }
print ENCL <<EOF;
</volume>
EOF
...
# bottom CRT-DP module
        my @poscrtbottom = (0., $BottomCRTDPModHeight/2. - $BottomCRTDPPaddleHeight/2., 0.);
print ENCL <<EOF;
...
EOF
    ...
    <physvol name="CRTDPBOTTOM$padnum" copynumber="$paddleindex">
      ...
      <position name="posCRTPaddleSensitiveBottom$padnum" unit="mm" x="0" y="$poscrtbottom[1]" z="0"/> 
      <rotationref ref="rMinus90AboutY"/>
    </physvol>
EOF
        $poscrtbottom[1] -= $CRTDPPaddleSpacing;
...
EOF
    ...
    <position name="posSteelSupport_Top" x="0" y="@{[$posTopSteelStruct]}" z="0" unit="cm"/>
    ...
    <volumeref ref="volSteelSupport_TB"/>
    <position name="posSteelSupport_Bottom" x="0" y="@{[$posBotSteelStruct]}" z="0" unit="cm"/>
    ...
    <position name="posSteelSupport_LS" x="@{[$posLeftSteelStruct]}" y="0" z="0" unit="cm"/>
    ...
    <volumeref ref="volSteelSupport_LR"/>
    <position name="posSteelSupport_RS" x="@{[$posRightSteelStruct]}" y="0" z="0" unit="cm"/>
    <rotation name="rotSteelSupport_RS" x="0" y="90" z="0" unit="deg"/>
    </physvol>
    
EOF

#flagtemp below, chaged x --> y and y --> -x
    ...
    <physvol>
       ...
       <position name="posBeamWinFoam" unit="cm"
         ...
         y="$BeamWFo_x"
         z="$BeamWFo_z"/>
       <rotationref ref="rBeamWRev3DriftY"/>
    </physvol>
...
EOF
    ...
    #############  existing NP02 CRT, used for Double Phase data taking
    if($DP_CRT_switch eq "on"){
        ## position for driftX  original DP NP02 position
        #my @posCRT_DP_top = (4345, 5882, -1656); #mm
        ##position for driftY original DP NP02 position
        #my @posCRT_DP_top = (-5882, 4345, -1656); #mm #flag
        ##position for driftY module0
        my @posCRT_DP_top = ( -5882, 4345, 0); #mm #flag
        print ENCL <<EOF;
    <physvol>
        <volumeref ref="volAuxDetCRTDPModuleTop"/>
        <position name="posCRTDPTOPSensitive_1" unit="mm" x="-5882" y="3848" z="0"/>
        <rotationref ref="rIdentity"/>
    </physvol>
EOF
##        my $widthPalette=132+10; # spacing between paddle (mm)
...
##            print ENCL <<EOF;
##    <physvol>
##        <volumeref ref="volAuxDetSensitiveCRTDPTOP$padnum"/>
##        <position name="posCRTDPTOPSensitive_$padnum" unit="mm" x="$posCRT_DP_top[0]" y="$posCRT_DP_top[1]" z="$posCRT_DP_top[2]"/>
##        <rotationref ref="rMinus90AboutY"/>
##    </physvol>
##EOF
##            #$posCRT_DP_top[0]-=$widthPalette;
##            $posCRT_DP_top[1]-=$widthPalette; #flag
##        }
        ## position for driftX original DP NP02 position
        #my @posCRT_DP_bot = (-737, -5882, -1656); #mm
        ##position for driftY original DP NP02 position
        #my @posCRT_DP_bot = (5882, -737, -1656); #mm #flag
        ##position for driftY module0
        my @posCRT_DP_bot = (5882, -3909, -0); #mm #flag
        print ENCL <<EOF;
    <physvol>
        <volumeref ref="volAuxDetCRTDPModuleBottom"/>
        <position name="posCRTDPBOTTOMSensitive_1" unit="mm" x="5882" y="-4406" z="0"/>
        <rotationref ref="rIdentity"/>
    </physvol>
EOF
##        for($i=0 ; $i<8 ; $i++){
...
##            print ENCL <<EOF;
##    <physvol>
 ##       <volumeref ref="volAuxDetSensitiveCRTDPBOTTOM$padnum"/>
##        <position name="posCRTDPBOTTOMSensitive_$padnum" unit="mm" x="$posCRT_DP_bot[0]" y="$posCRT_DP_bot[1]" z="$posCRT_DP_bot[2]"/>
##        <rotationref ref="rMinus90AboutY"/>
##    </physvol>
##EOF
            #$posCRT_DP_bot[0]-=$widthPalette;
##            $posCRT_DP_bot[1]-=$widthPalette; #flag
##        }
    } # end of $DP_CRT_switch eq "on"
