...
# and open it
    $MAT = "pdhd_v4_Materials" . $suffix . ".gdml";
    push (@gdmlFiles, $MAT);
    $MAT = ">" . $MAT;
...
# add file to list of output GDML fragments,
# and open it
    $TPC = "pdhd_v4_TPC_${_[3]}" . $suffix . ".gdml";
    push (@gdmlFiles, $TPC);
    $TPC = ">" . $TPC;
...
# add file to list of output GDML fragments,
# and open it
    $CRYO = "pdhd_v4_Cryostat" . $suffix . ".gdml";
    push (@gdmlFiles, $CRYO);
    $CRYO = ">" . $CRYO;
...
# add file to list of output GDML fragments,
# and open it
    $ENCL = "pdhd_v4_DetEnclosure" . $suffix . ".gdml";
    push (@gdmlFiles, $ENCL);
    $ENCL = ">" . $ENCL;
...
# add file to list of output GDML fragments,
# and open it
    $WORLD = "pdhd_v4_World" . $suffix . ".gdml";
