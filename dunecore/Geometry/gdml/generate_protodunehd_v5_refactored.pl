...
print CRYO <<EOF;
      <physvol name="volEWProfile_$i">
        ...
        <position name="posEWProfile_$i" x="$ewprof_x" y="0" z="-2.24" unit="cm"/>	
      </physvol>
EOF
}
...
print CRYO <<EOF;
      <physvol name="volFCProfile_$i">
        ...
        <position name="posFCProfile_$i" x="$fcprof_x" y="-4.78" z="0" unit="cm"/>      
      </physvol>
EOF
}
...
$FCmodRight_x[$cpa_i]  = $CPA_x + 3 + 344/2; #352/2; # CPAmodCenter_x to FCmodCenter_x 
$FCmodLeft_x[$cpa_i]   = $CPA_x - 3 - 344/2; #352/2;
