...
perl generate_protodunevd_v4_refactored.pl -o protodunevd_v4_nowires.xml -w=1 -s="parts"
perl make_refactored_gdml.pl -i protodunevd_v4_nowires.xml -o protodunevd_v4_refactored.gdml
