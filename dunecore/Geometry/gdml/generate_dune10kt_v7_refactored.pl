...
# Update: v6 2024/01/15, Viktor Pec (viktor.pec@fzu.cz)
#   Changed material of wire boards from G10 to FR4.
# Update: v7 2024/03/07, Viktor Pec (viktor.pec@fzu.cz)
#   Generating new full-volume gdmls.
#
###
...
# Print out useful geometry info
$TPCActive_x = $TPC_x -(3*$APAWirePlaneSpacing);
$TPCActive_y = $TPC_y  - $APAGap_y/2 - $ReadoutBoardOverlap ; #TODO: make the Active height more accurate
$TPCActive_z = $TPC_z ;

print "Some of the principal parameters for this TPC geometry (unit cm unless noted otherwise)\n";
print " APA active area (U plane)	: $UActive_z x $UActive_y\n";
print " APA total area			: $APAphys_z x $APAphys_y\n";
print " Wire pitch in U, V, Z		: $UWirePitch, $VWirePitch, $XWirePitch\n";
print " TPC active volume		: $TPCActive_x x $TPCActive_y x $TPCActive_z\n";
