////////////////////////////////////////////////////////////////////////
/// \file  ProtoDUNEWireReadoutGeomv8.cxx
...
using std::map;
using geo::ProtoDUNEWireReadoutGeomv8;
using std::cout;
using std::endl;
using std::setw;
...
//----------------------------------------------------------------------------
  ...
  ProtoDUNEWireReadoutGeomv8::ProtoDUNEWireReadoutGeomv8(fhicl::ParameterSet const& p,
...
//----------------------------------------------------------------------------
  ...
  Index ProtoDUNEWireReadoutGeomv8::NOpChannels(Index /*NOpDets*/) const {
    return fNOpChannels;
  }

//----------------------------------------------------------------------------

  Index ProtoDUNEWireReadoutGeomv8::MaxOpChannel(Index /*NOpDets*/) const {
    return fMaxOpChannel;
  }

//----------------------------------------------------------------------------

  Index ProtoDUNEWireReadoutGeomv8::NOpHardwareChannels(Index opDet) const {
...
//----------------------------------------------------------------------------
  ...
  Index ProtoDUNEWireReadoutGeomv8::OpChannel(Index detNum, Index channel) const {
    ...
    if (sspch > 12) {
        mf::LogError("ProtoDUNEWireReadoutGeomv8") << "Invalid address: SSP #" << ssp << ", SSP channel" << sspch;
    }
...
//----------------------------------------------------------------------------
  ...
  Index ProtoDUNEWireReadoutGeomv8::OpDetFromOpChannel(Index opChannel) const {
    if (!IsValidOpChannel(opChannel, 90)) {
      mf::LogWarning("ProtoDUNEWireReadoutGeomv8") << "Requesting an OpDet number for an uninstrumented channel, " << opChannel;
      return 99999;
    }
...
//----------------------------------------------------------------------------
  ...
  Index ProtoDUNEWireReadoutGeomv8::HardwareChannelFromOpChannel(Index opChannel) const {
    if (!IsValidOpChannel(opChannel, 90)) {
      mf::LogWarning("ProtoDUNEWireReadoutGeomv8") << "Requesting an OpDet number for an uninstrumented channel, " << opChannel;
      return 99999;
    }
...
//----------------------------------------------------------------------------
  ...
  Index ProtoDUNEWireReadoutGeomv8::OpChannelFromSSP(Index ssp, Index sspch) const {
...
//----------------------------------------------------------------------------
  ...
  void ProtoDUNEWireReadoutGeomv8::PrintChannelMaps() const {
