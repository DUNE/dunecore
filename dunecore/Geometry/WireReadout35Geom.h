...
///
#ifndef GEO_WIREREADOUT35GEOM_H
#define GEO_WIREREADOUT35GEOM_H
...
namespace geo{
  ...
  class WireReadout35Geom : public WireReadoutGeom{

  public:

    WireReadout35Geom(fhicl::ParameterSet const& pset, GeometryCore const* geom);
