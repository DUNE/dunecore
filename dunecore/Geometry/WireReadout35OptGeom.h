...
namespace geo{
  ...
  class WireReadout35OptGeom : public WireReadoutGeom{

  public:

    explicit WireReadout35OptGeom(fhicl::ParameterSet const& p, GeometryCore const* geom);
