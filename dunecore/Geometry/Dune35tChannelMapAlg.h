// Dune35tChannelMapAlg.h

// David Adams
// October 2016
//
// Copied from ChannelMap35OptAlg and modified to support ROPs and to
// include four planes per APA instead of three.

#ifndef Dune35tChannelMapAlg_H
#define Dune35tChannelMapAlg_H
...
class Dune35tChannelMapAlg : public ChannelMapAlg {

public:

  Dune35tChannelMapAlg(fhicl::ParameterSet const& p);
...
private:
  ...
  PlaneInfoMap_t<unsigned int>                         fWiresPerRop;    ///< The number of wires in each plane in a ROP
  ...
  unsigned int WiresPerPlane(geo::PlaneID const& planeid) const
    { return AccessAPAelement(fWiresPerRop, planeid); }
